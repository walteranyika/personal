...
public class BleedingActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		getActionBar().setTitle(Html.fromHtml("<h5><font color='#ffffff'>Bleeding|First Aid</font></h5>"));
		
		getActionBar().setIcon(R.drawable.woundicon);
		
info=(TextView) findViewById(R.id.tvBleeding);
...
info.setTypeface(font);
		...
		String res = null;
		try {
			res = new TextFilesReader(this).readTxt("bleeding.txt");
		} catch (IOException e) {
	...
	{
		startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.youtube.com/watch?v=BQRqUxB5pn0")));
	}
