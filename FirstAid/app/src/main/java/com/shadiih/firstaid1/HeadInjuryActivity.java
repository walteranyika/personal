...
public class HeadInjuryActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		getActionBar().setTitle(Html.fromHtml("<h5><font color='#ffffff'>Head|Injury|First Aid</font></h5>"));
		
		getActionBar().setIcon(R.drawable.woundicon);
		
info=(TextView) findViewById(R.id.tvHeadInjury);
Typeface font=Typeface.createFromAsset(getAssets(), "fonts/Aller.ttf");
info.setTypeface(font);
		
		String res = null;
		try {
			res = new TextFilesReader(this).readTxt("headinjury.txt");
		} catch (IOException e) {
	...
	public void head_injury(View v)
	{
		startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.youtube.com/watch?v=OqDdLUi7kkA")));
	}
